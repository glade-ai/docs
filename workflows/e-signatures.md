...
> TODO: Document how an e-signature request is created, how signers are chosen, and how a request is voided. This page currently covers the request lifecycle and what each party sees at each stage.
...
- A voided request is removed from the client's path and cannot be acted on — see [Client Portal](../intake/client-portal.md).
